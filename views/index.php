...
<table class="form-table">
    <tbody>
        <tr>
            ...
            <td>
                <input name="gh_token" type="text" id="gh_token" value="<?php echo esc_attr(get_option('gh_token')); ?>" class="regular-text">
...
<table class="form-table">
    <tbody>
        ...
        <tr>
            ...
            <td>
                <input name="bb_pass" type="password" id="bb_pass" class="regular-text">
